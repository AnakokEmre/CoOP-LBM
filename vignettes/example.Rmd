...
par(pty="s")
plot(lambda_i[obsrow],model2$lambda,main = "Lambda",xlab = "Theorical",ylab="Estimated")
abline(0,1,lty=2)
plot(mu_j[obscol],model2$mu,main = "Mu",xlab = "Theorical",ylab="Estimated")
abline(0,1,lty=2)
plot(N0[obsrow,obscol],model2$lambda_mu_G,main = "Lambda Mu G",xlab = "Theorical",ylab="Estimated")
abline(0,1,lty=2)
...
p1 <- ggplot(df1_long, aes(x=factor(G),y=value,fill=variable))+
  geom_boxplot() +  theme(legend.position = "bottom",axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ggtitle("ARI for row clustering")+ labs(y="ARI",x="G")+scale_fill_discrete(labels = c("LBM","CoOP-LBM"))+ guides(fill=guide_legend(title=""))
...
p2 <- ggplot(df2_long, aes(x=factor(G),y=value,fill=variable))+
  geom_boxplot()  +  theme(legend.position = "bottom",axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ggtitle("ARI for column clustering")+ labs(y="",x="G")+scale_fill_discrete(labels = c("LBM","CoOP-LBM")) + guides(fill=guide_legend(title=""))
...
p7 <- ggplot(df3_long, aes(x=factor(G),y=value,fill=variable))+
  ...
  scale_fill_discrete(labels = c("Observed matrix","Chao","CoOP-LBM"))+
   labs(linetype="")+
...
p8 <- ggplot(df4_long, aes(x=factor(G),y=value,fill=variable))+
  geom_boxplot()  +  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ggtitle("RMSE of row coverage") + scale_fill_discrete(labels = c("Chao","CoOP-LBM"))+labs(y="RMSE",x="G")+ guides(fill=guide_legend(title=""))
...
p9 <- ggplot(df5_long, aes(x=factor(G),y=value,fill=variable))+
  geom_boxplot()  +  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ggtitle("RMSE of column coverage") + scale_fill_discrete(labels = c("Chao","CoOP-LBM"))+labs(y="RMSE",x="G")+ guides(fill=guide_legend(title=""))
...
p10 <- ggplot(df6_long, aes(x=factor(G),y=value,fill=variable))+
  ...
  ggtitle("Nestedness")+
  scale_fill_discrete(labels = c("Observed matrix","Oracle LBM","CoOP-LBM","Randomly completed"))+
...
p13 <- ggplot(df9_long, aes(x=factor(G),y=value,fill=variable))+
  geom_boxplot()  +  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ggtitle("AUC for missing data")+scale_fill_discrete(labels = c("LBM","CoOP-LBM")) + guides(fill=guide_legend(title=""))+labs(y="AUC",x="G")
p13
```
